...
body{
	background: url("https://img.freepik.com/free-photo/hammocks-umbrella-placed-near-large-pool_1203-192.jpg?w=996&t=st=1667720331~exp=1667720931~hmac=16170f52957bc2b264cedcb9a6f0bffbc29406c833c95e7fbca50d60d78f0893");
		...
		<div>
  			<div class="container">
    				...
    				<hr>
    					...
    					<label for="inDate"><b>Check-In Date</b></label>
    					<input placeholder="Date" name="inDate" id="inDate" required>

    					<label for="outDate"><b>Check-Out Date</b></label>
    					<input placeholder="Date" name="outDate" id="outDate" required>

    				<hr>

    				<button class="registerbtn" onclick="go();">Find Hotels</button>
  			</div>
		</div>
